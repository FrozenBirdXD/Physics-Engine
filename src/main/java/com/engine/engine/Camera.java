...
public class Camera {
    ...
    public void adjustProjection() {
        ...
        // (0, 1920, 0, 1080, 0.5, 100) as inputs, this means that the camera can "see" any objects that are between x-coordinates 0 and 1920, and y-coordinates 0 and 1080, and z-coordinates 0.5-100
